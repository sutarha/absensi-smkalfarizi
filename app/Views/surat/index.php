                                    ...
                                    <tr class="hover:bg-slate-50/70 transition">
                                        ...
                                        <td class="py-3.5 px-4 text-center">
                                            <div class="inline-flex items-center gap-1.5">
                                                ...
                                                <form method="POST" action="<?= App::baseUrl("admin/surat/delete/{$s['id']}") ?>" onsubmit="return confirm('Apakah Anda yakin ingin menghapus surat ini dari arsip?');" class="inline">
